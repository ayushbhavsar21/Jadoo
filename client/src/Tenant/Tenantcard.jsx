    ...
    <div className='w-[90vw] bg-tertiary flex justify-center py-8 mx-auto'>
      <div className='sm:w-85vw w-95vw p-4 bg-white rounded-3xl flex flex-col justify-center gap-8 items-center xl:h-400px font-playfair shadow-2xl xl:flex-row h-auto'>
        <div className='lg:w-35% sm:w-60% w-95% rounded-3xl flex items-center justify-start'>
          <img src="https://images.unsplash.com/photo-1522199755839-a2bacb67c546?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGJsb2d8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60" className='object-cover rounded-3xl' alt="" />
        </div>
        <div className='xl:w-58% w-90% flex flex-col justify-center items-center xl:justify-start  gap-4'>
          <p className='text-xl'>₹1000000</p>
          <p className='text-xl font-semibold'>Residential Plot</p>
          ...
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deleniti sapiente et dolore dolorem modi, laborum ipsum dolor saepe ea excepturi est tenetur quis doloribus mollitia quo tempore facilis nisi velit!</p>
